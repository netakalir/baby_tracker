...
/** The Google "G" mark, inlined so no external asset/network request is needed. */
function GoogleIcon() {
  return (
...
export function AuthPage() {
  ...
  // On success the page redirects to Google, so there is no onSuccess to handle;
  // only a failure to start the redirect surfaces here as an error.
    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <Card className="max-w-sm">
        ...
        {googleMutation.isError && (
          <div className="mb-4">
            <Banner variant="error" message={toFriendlyAuthErrorMessage(googleMutation.error)} />
          </div>
        )}
